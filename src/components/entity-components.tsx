...
export const EntityContainer = ({ children, search, header, pagination }: EntityContainerProps) => {
    return (
...
export const EntitySearch = ({
    ...
    return (
        <div className="relative ml-auto">
            ...
            <Input
            className="max-w-[220px] h-8 bg-background shadow-none border-border pl-8 focus-visible:ring-1"
